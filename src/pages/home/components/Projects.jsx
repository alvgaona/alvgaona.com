...
const Projects = (): React.Node => {
  ...
  return (
    <section className="section meta-projects">
      <div
        className="flex flex-col justify-center z-10 background-image background-image-size"
        style={{ backgroundImage: `url(${photo.backgroundImage.childImageSharp.original.src})` }}
      >
        <div className="pl-8">
