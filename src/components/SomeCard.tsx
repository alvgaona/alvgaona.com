...
const SomeCard = (props: Props) => (
    <HoverCard>
        <HoverCardTrigger asChild className="delay-0!">
            <a href={props.href} className="underline decoration-[#FFC799] underline-offset-4 hover:animate-pulse">
                {props.text}
            </a>
        </HoverCardTrigger>
            ...
            <div className="dark:bg-slate-gray flex justify-evenly space-x-4">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-1 pt-2">
                        ...
                        <span className="text-muted-foreground text-xs">{props.footer}</span>
                    </div>
                </div>
            </div>
        </HoverCardContent>
