...
The first beat is called S1 and the second beat is called S2, and the time between S1 and S2 is called
_systole interval_ and the time between S2 and the next S1 is called _diastole interval_.
