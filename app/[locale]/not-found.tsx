      ...
      <main className="pt-[56px]">
        <article className="mx-auto max-w-2xl px-8">
          <div className="my-24 flex flex-col items-center justify-center">
            <h1 className="text-center font-mplus text-2xl font-bold">{t('notFound.title')}</h1>
            <p className="text-md border-b-1 mt-4 border-solid px-4 pb-4">{t('notFound.subtitle')}</p>
            <Link
              href="/"
