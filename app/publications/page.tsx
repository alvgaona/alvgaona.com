...
const Publications = (): React.ReactNode => (
  <section className="flex flex-col items-start">
    <div className="mb-6 ml-4 mt-2 border-b border-solid pb-3 text-justify">
      <p className="pt-2">
        Research is a passion of mine, and I consider it a significant component of my life. I relish the challenge of
        discovering original solutions to complex problems, with a particular focus on the fascinating fields of Control
        Systems, Signal Processing, and Machine Learning.
      </p>
      <p className="pt-2">
        My journey into research began with my first publication in the field of signal processing for biomedical
        signals. I firmly believe that there is a wealth of untapped potential in applying learning algorithms within
        the biomedical universe. Not only can we continue to enhance our knowledge of the intricacies of the human body,
        but we can also empower healthcare experts with advanced tools and skills to revolutionize the industry.
      </p>
      <p className="pt-2">
